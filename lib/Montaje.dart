...
void main() => runApp(MaterialApp(home: MontajePage()));

class MontajePage extends StatefulWidget {
  @override
  _MontajePageState createState() => _MontajePageState();
}

class _MontajePageState extends State<MontajePage> {
...
for (var record in records) {
 ...
 if (fields['Linea 4'] == 'Verdadero'&&fields['Montaje Estado'] == 'Falso'&&fields['En Linea'] == 'Verdadero') {
...
DateTime fechaEntrega = fields['Fecha de fin'] == null || fields['Fecha de fin'].isEmpty
 ...
 : DateTime.parse(fields['Fecha de fin']);
   ...
   String nota = fields['Nota Montaje']; // Agrega esta línea
  ...
  // Filtra los registros donde la línea es "Linea 1 y 2"
 if (fields['Linea 4'] == 'Falso'&&fields['Montaje Estado'] == 'Verdadero'&&fields['En Linea'] == 'Verdadero') {
   int AvanceProyecto1 = fields['Montaje'];
   int RestanteProyecto1 = fields['Restante Montaje'];
   DateTime fechaInicio = fields['Fecha de inicio'] == null || fields['Fecha de inicio'].isEmpty
 ? DateTime.now() // O cualquier otro valor predeterminado que desees
...
TextField(
 ...
 onPressed: () {
   ...
   if (username == 'luis' && password == '5740'||username == 'justino' && password == '2020') {
              ...
              if (piezasTerminadas <= restanteSoldadura) {
                ...
                if (avanceProyecto1 >= 0) {
                  ...
                  updateAirtableRecord(data['id'], {
                    'Montaje': avanceProyecto1,
                    'Restante Montaje': restanteProyecto1,
        ...
        actions: [
          TextButton(
            onPressed: () async {
              ...
              // Actualiza el registro en Airtable
              await updateAirtableRecord(recordId, {'Nota Montaje': newNote});
