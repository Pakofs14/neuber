...
void main() => runApp(MaterialApp(home: Nave1Page()));

class Nave1Page extends StatefulWidget {
  @override
  _Nave1PageState createState() => _Nave1PageState();
}

class _Nave1PageState extends State<Nave1Page> {
...
for (var record in records) {
 ...
 if (fields['Nave 1'] == 'Verdadero' &&fields['En Linea'] == 'Verdadero') {
...
DateTime fechaEntrega = fields['Fecha de fin'] == null || fields['Fecha de fin'].isEmpty
 ...
 : DateTime.parse(fields['Fecha de fin']);
   ...
   String nota = fields['Nota Nave 1']; // Agrega esta línea
...
TextField(
 ...
 onPressed: () {
   ...
   if ((username == 'aldo' && password == '3958') ||
                 (username == 'justino' && password == '2020') ||
                 (username == 'ricardo' && password == '1936')) {
              ...
              if (piezasTerminadas <= restanteSoldadura) {
                ...
                if (avanceProyecto1 >= 0) {
                  ...
                  updateAirtableRecord(data['id'], {
                    'Pintura': avanceProyecto1,
                    'Restante Pintura': restanteProyecto1,
        ...
        actions: [
          TextButton(
            onPressed: () async {
              ...
              newNote += '\n\nFecha: $formattedDate \nEditado por encargado Pintura';
              Navigator.of(context).pop();

              // Actualiza el registro en Airtable
              await updateAirtableRecord(recordId, {'Nota Nave 1': newNote});
