...
void main() => runApp(MaterialApp(home: Linea3y4Page()));

class Linea3y4Page extends StatefulWidget {
  @override
  _Linea3y4PageState createState() => _Linea3y4PageState();
}

class _Linea3y4PageState extends State<Linea3y4Page> {
...
void initState() {
 ...
 fetchAirtableData().then((data) {
  ...
  bool _validateCredentials(String user, String password) {
    return user == 'victor' && password == '0504';
  }
...
Future<List<Map<String, dynamic>>> fetchAirtableData() async {
 ...
 if (response.statusCode == 200) {
  ...
  if (fields['Linea 2'] == 'Verdadero'&&fields['En Linea'] == 'Verdadero') {
    ...
    String nota = fields['Nota Linea 3 y 4']; // Agrega esta línea
    ...
    result.add({
      ...
      'hora': hora, 
      'Cama L2': fields['Cama L2'], // Agrega el campo Cama L1
      'Huacal L2': fields['Huacal L2'], // Agrega el campo Huacal L1
      'Soldadura L2': fields['Soldadura L2'], // Agrega el campo Interiores L1
      'Interiores L2': fields['Interiores L2'], // Agrega el campo Soldadura L1
...
TextField(
 ...
 onPressed: () {
   ...
   if (username == 'victor' && password == '0504') {
  ...
  if ((data.containsKey('Huacal L2') && data['Huacal L2'] == 'Verdadero') ||
    ...
    Navigator.of(context).push(
      PageRouteBuilder(
        ...
        pageBuilder: (_, __, ___) => DesglosadoSPage(linea: 'L2', proyecto: nombreProyecto), // Pasa nombreProyecto en lugar de 'title'
