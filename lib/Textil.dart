...
void main() => runApp(MaterialApp(home: TextilPage()));

class TextilPage extends StatefulWidget {
  @override
  _TextilPageState createState() => _TextilPageState();
}

class _TextilPageState extends State<TextilPage> {
...
Future<List<Map<String, dynamic>>> fetchAirtableData() async {
 ...
 if (response.statusCode == 200) {
  ...
  if (fields['Linea 5'] == 'Verdadero'&&fields['En Linea'] == 'Verdadero') {
    int AvanceProyecto1 = fields['Textil'];
    int RestanteProyecto1 = fields['Restante Textil'];
...
TextField(
 ...
 onPressed: () {
   ...
   if (username == 'araceli' && password == '2024') {
              ...
              if (piezasTerminadas <= restanteSoldadura) {
                ...
                if (avanceProyecto1 >= 0) {
                  ...
                  updateAirtableRecord(data['id'], {
                    'Textil': avanceProyecto1,
                    'Restante Textil': restanteProyecto1,
        ...
        actions: [
          TextButton(
            onPressed: () async {
              ...
              // Actualiza el registro en Airtable
              await updateAirtableRecord(recordId, {'Nota Textil': newNote});
