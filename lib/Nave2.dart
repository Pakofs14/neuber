...
void main() => runApp(MaterialApp(home: Nave2Page()));

class Nave2Page extends StatefulWidget {
  @override
  _Nave2PageState createState() => _Nave2PageState();
}

class _Nave2PageState extends State<Nave2Page> {
...
for (var record in records) {
 ...
 if (fields['Nave 2'] == 'Verdadero' &&fields['En Linea'] == 'Verdadero') {
...
DateTime fechaEntrega = fields['Fecha de fin'] == null || fields['Fecha de fin'].isEmpty
 ...
 : DateTime.parse(fields['Fecha de fin']);
   ...
   String nota = fields['Nota Nave 2']; // Agrega esta línea
    ...
    body: FutureBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Mensaje de "No se encontraron proyectos"
          return Center(
            child: Column(
          ...
          // Si hay datos, se muestran las gráficas
        ...
        actions: [
          TextButton(
            onPressed: () async {
              ...
              // Actualiza el registro en Airtable
              await updateAirtableRecord(recordId, {'Nota Nave 2': newNote});
